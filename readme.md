# Hi, I'm Sethu 👋
I am an **AI Engineer** building a platform that makes lawyers 10X productive. Before this, I was a Software Engineer at [Microsoft](https://github.com/microsoft), where I worked on an Azure product impacting over 100M+ users worldwide. Before that I helped build a software that helps analyzing neutron reflectivity data from particle acclerator at [STFC, UKRI](https://www.ukri.org/councils/stfc/).

Open-source Projects
 - [MetalExplorer](https://github.com/sethupavan12/MetalExplorer) - Modern macOS task manager for modern problems in the age of high-autonomy, low-observability agentic software, monitor agents, MCPs, and dev servers
